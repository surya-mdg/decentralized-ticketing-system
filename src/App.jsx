...
import SellTicket from "./pages/users-pages/SellTicket";
import BuyTicket from "./pages/users-pages/BuyTicket";

window.Buffer = buffer.Buffer;

import { contractAdd } from "/constants.js";
...
function App() {
    ...
    const [event, setEvent] = useState({
        tokenId: 0,
        name: "Harmony Haven Live",
        time: "15:00 | 19/09/2024",
        location: "Neon Nights Club, Brickton",
        seat: "middle",
        type: 0
    });
    ...
    const [cost, setCost] = useState({ ticketCost: 2 });
    ...
    const findAuthorizedAccount = async () => {
        ...
        try {
            ...
            if (accounts.length == 0) {
                console.log(
                    "findAuthorizedAccount: No authorized accounts found"
                );
        ...
        <BrowserRouter>
            <Routes>
                ...
                >
                    ...
                    <Route
                        path="/events"
                        element={<EventsPage event={setEvent} />}
                    />
                    <Route
                        path="/book-event"
                        element={
                    ...
                    <Route
                        path="/book/ticket"
                        element={
                            <BookedTicket event={event} account={account} />
                        }
                    />
