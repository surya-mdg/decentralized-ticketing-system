...
const TicketCard = (props) => {
    return (
        <Card
            className=" min-w-72 aspect-[9/12] flex flex-col items-center gap-y-4 justify-center"
            style={{
                backgroundImage: `url(${"/src/img/concert-3-bw.jpg"})`,
        ...
        >
            ...
            <CardContent className="flex flex-col gap-y-4 justify-left">
                <CardDescription
                    style={{ backgroundColor: "black", padding: "0.1em 0.3em" }}
                >
                    {"Row: "}
